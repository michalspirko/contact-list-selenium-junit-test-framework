...
public class CNC_005_WrongFormatOptionalEmailCreateContactTest extends BaseTest {
    ...
    // Test
    @ParameterizedTest
    @CsvFileSource(resources = "/TS3_create_new_contact/CNC_005_WrongFormatOptionalEmailCreateContact_data.csv",
            numLinesToSkip = 1, delimiter = ';')
    void wrongEmailFormatCreateContactTest(String firstName, String lastName, String email, String expectedError,
