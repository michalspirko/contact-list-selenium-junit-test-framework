...
public class DEL_003_CancelContactDeletionTest extends BaseTest {
    //Fields
    ...
    // Test
    @ParameterizedTest
    @CsvFileSource(resources = "/TS6_delete_contact/DEL_003_CancelContactDeletion_data.csv",
            numLinesToSkip = 1, delimiter = ';')
    void cancelContactDeleteTest(String firstName, String lastName,String expectedFullName, String dateOfBirth, String email,
        ...
        //Action - Cancel Contact Deletion
        myContactsPage = contactDetailsPage.cancelContactDeletion();
        ...
        assertAll(
                ...
                //The contact is present after canceled deletion
                () -> assertTrue(isContactPresent,"The contact is absent after canceling the deletion."),
                //
                () -> assertEquals(expectedFullName,fullName,
                        "The contact is absent after canceling the deletion."));
    }
}
