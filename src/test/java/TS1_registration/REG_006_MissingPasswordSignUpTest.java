...
public class REG_006_MissingPasswordSignUpTest extends BaseTest {
    ...
    // Test
    @ParameterizedTest
    @CsvFileSource(resources = "/TS1_registration/REG_006_MissingPasswordSignup_data.csv", numLinesToSkip = 1,
            delimiter = ';')
    void missingPasswordSignUpTest(String firstName, String lastName, String email, String password,
