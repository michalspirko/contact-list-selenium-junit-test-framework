...
public class DCD_001_AllFieldsDisplayContactDetailsTest extends BaseTest {
    ...
    // Test
    @ParameterizedTest
    @CsvFileSource(resources = "/TS4_display_contact_details/DCD_001_AllFieldsDisplayContactDetails_data.csv",
            numLinesToSkip = 1, delimiter = ';')
    void allFieldsDisplayContactTest(String expectedFirstName, String expectedLastName,
        ...
        String dateOfBirth = contactDetailsPage.getDateOfBirth();
        String email = contactDetailsPage.getEmail();
        String phone = contactDetailsPage.getPhone();
        String streetAddress1 = contactDetailsPage.getStreetAddress1();
        String streetAddress2 = contactDetailsPage.getStreetAddress2();
        String city = contactDetailsPage.getCity();
        String stateProvince = contactDetailsPage.getStateProvince();
        String postalCode = contactDetailsPage.getPostalCode();
        String country = contactDetailsPage.getCountry();
        ...
        assertAll(
                ...
                () -> assertEquals(expectedBirthDate, dateOfBirth, "The date of birth is incorrect."),
                () -> assertEquals(expectedEmail, email, "The email is incorrect."),
                () -> assertEquals(expectedPhone, phone, "The phone number is incorrect."),
                () -> assertEquals(expectedStreet1, streetAddress1, "The street address 1 is incorrect."),
                () -> assertEquals(expectedStreet2, streetAddress2, "The street address 2 is incorrect."),
                () -> assertEquals(expectedCity, city, "The city is incorrect."),
                () -> assertEquals(expectedStateProvince, stateProvince, "The state/province is incorrect."),
                () -> assertEquals(expectedPostalCode, postalCode, "The postal code is incorrect."),
                () -> assertEquals(expectedCountry, country, "The country is incorrect."));
    }
}
